...
<solution name="mbeddr.concurrent.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#mbeddr.concurrent.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
