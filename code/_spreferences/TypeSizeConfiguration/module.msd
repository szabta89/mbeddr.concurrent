...
<solution name="mbeddr.concurrent.__spreferences.TypeSizeConfiguration" uuid="~_PreferencesModule#mbeddr.concurrent.__spreferences.TypeSizeConfiguration" moduleVersion="0" compileInMPS="true">
  <models>
  ...
  <dependencyVersions>
    <module reference="~_PreferencesModule#mbeddr.concurrent.__spreferences.TypeSizeConfiguration(mbeddr.concurrent.__spreferences.TypeSizeConfiguration)" version="0" />
  </dependencyVersions>
</solution>
